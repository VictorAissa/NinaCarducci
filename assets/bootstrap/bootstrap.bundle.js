...
!(function (t, e) {
    ...
    class wt extends H {
        ...
        _addEventListeners() {
            this._config.keyboard &&
                P.on(this._element, lt, (t) => this._keydown(t)),
    ...
    function Te(t) {
        for (
            var e = he(t), i = Ae(t);
            i && ye(i) && "static" === be(i).position;

        )
            i = Ae(i);
        return i &&
            ("html" === ce(i) ||
                ("body" === ce(i) && "static" === be(i).position))
            ? e
            : i ||
                  (function (t) {
                      var e =
                  ...
                  (function (t) {
                      ...
                      return (
                          "rtl" === be(s || i).direction &&
                              (a +=
                                  Ce(i.clientWidth, s ? s.clientWidth : 0) - o),
    ...
    class Rn extends H {
        ...
        show(t) {
            ...
            if (
                P.trigger(this._element, In, { relatedTarget: t })
                    .defaultPrevented
            )
                return;
            (this._isShown = !0),
    ...
    const Wn = new Set([
        ...
        Fn = (t, e) => {
            ...
            if (e.includes(i))
                return (
                    !Wn.has(i) ||
                    Boolean(zn.test(t.nodeValue) || qn.test(t.nodeValue))
                );
    ...
    class cs extends H {
        ...
        _getConfig(t) {
            ...
            return (
                ...
                t.sanitize &&
                    (t.template = Vn(t.template, t.allowList, t.sanitizeFn)),
                t
            );
        }
        _getDelegateConfig() {
            ...
            i.classList.add(As),
                i.classList.contains(Es)
                    ...
                    : Y.parents(i, ".nav, .list-group").forEach((t) => {
                          Y.prev(t, `${Ts}, ${Os}`).forEach((t) =>
                              t.classList.add(As)
                          ),
                              Y.prev(t, ".nav-item").forEach((t) => {
                                  Y.children(t, Ts).forEach((t) =>
                                      t.classList.add(As)
                                  );
                              });
                      }),
    ...
    class Rs extends H {
        ...
        show() {
            ...
            const s = t
                ? P.trigger(t, $s, { relatedTarget: this._element })
                : null;
            if (
                P.trigger(this._element, Ss, { relatedTarget: t })
                    .defaultPrevented ||
        ...
        _activate(t, e, i) {
            ...
            n && s
                ? (n.classList.remove(Ms), this._queueCallback(o, t, !0))
                : o();
        }
